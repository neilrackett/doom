...
{
    patch_t *page = W_CacheLumpName(pagename, PU_CACHE);

#ifdef __EMSCRIPTEN__
    V_DrawPatchContain(page);
#else
    V_DrawPatch(0, 0, page);
#endif
}
...
void D_SetGameDescription(void)
{
    ...
    M_StringConcat(gamedescription, " | WebDOOM by Neil Rackett", strlen(gamedescription) + 32);
}
